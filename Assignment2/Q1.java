...
public class Q1 {
    public static void main(String [] args) {
        ...
        if(a.length()>b.length()&&flag==false) {
            System.out.println("Strings are Not Lexicographically Equal: "+a.charAt(b.length()-1));
        }
        else if(a.length()<b.length()&&flag==false) {
            System.out.println("Strings are Not Lexicographically Equal: "+b.charAt(a.length()-1));
        }
        else if(flag==false){
