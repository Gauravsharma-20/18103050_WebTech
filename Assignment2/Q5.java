...
public class Q5 {
    public static void main(final String[] args) {
        ...
        final int univ_max = obj.nextInt();

        System.out.print("Enter no of elements in set a and b: ");
        final int a = obj.nextInt(), b = obj.nextInt();

        final ArrayList<Integer> arr1 = new ArrayList<Integer>(), arr2 = new ArrayList<Integer>();

        System.out.println("Given elements to add in set (Anything outside universe will be replaced by 0): ");
        final ArrayList<Integer> universe = new ArrayList<Integer>();
        ...
        // Set Difference
        startTime = System.nanoTime();
        final ArrayList<Integer> diff1 = new ArrayList<Integer>();
        ...
        final ArrayList<Integer> diff2 = new ArrayList<Integer>();
        for (int i = 0; i < universe.size(); i++) {
            present = false;
            for (int j = 0; j < arr2.size(); j++) {
        ...
        // Using sets
        System.out.println("\n\nUsing sets");
        final Set<Integer> universe_s = new HashSet<Integer>(), s1 = new HashSet<Integer>(),
        ...
        // Union
        startTime = System.nanoTime();
        final Set<Integer> union_s = new HashSet<Integer>(a);
        union_s.addAll(s2);
        System.out.print("\nUnion of a and b: ");
        ...
        // Intersection
        startTime = System.nanoTime();
        final Set<Integer> intersection_s = new HashSet<Integer>(a);
        ...
        // Set Difference
        startTime = System.nanoTime();
        final Set<Integer> diff1_s = new HashSet<Integer>(universe_s), diff2_s = new HashSet<Integer>(universe_s);
